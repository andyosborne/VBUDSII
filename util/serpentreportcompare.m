function serpentreportcompare(dir4report, ...
    reportname, ...
    serpentdir, ...
    fname_det, ...
    Tally1, ...
...
for regidx = 1:g.nRegions
    ...
    printplotxsn(figdir, [reportname 'flux' num2str(p.resolveXS) 'vasm'], ...
        0, ...
        0, ...
        2, ...
        [], ...
    ...
    printplotxsn(figdir, [reportname 'flux' num2str(p.resolveXS) 'vbsm'], ...
        0, ...
        0, ...
        2, ...
        [], ...
    ...
    printplotxsn(figdir, [reportname 'flux' num2str(p.resolveXS) 'vam'], ...
        0, ...
        0, ...
        2, ...
        [], ...
    ...
    printplotxsn(figdir, [reportname 'flux' num2str(p.resolveXS) 'vas'], ...
        0, ...
        0, ...
        2, ...
        [], ...
    ...
    printplotxsn(figdir, [reportname 'flux' num2str(p.resolveXS) 'sm'], ...
        0, ...
        0, ...
        2, ...
        [], ...
    ...
    printplotxsn(figdir, [reportname 'flux' num2str(p.resolveXS) 'vavbs'], ...
        0, ...
        0, ...
        2, ...
        [], ...
...
fid = fopen([dir4report filesep reportname '.tex'],'w');
...
fprintf(fid,'\\section{Flux plot(s)}\n');
...
fprintf(fid,['\\fitzefigtwo{figs/' reportname 'flux' num2str(p.resolveXS) ...
    'vasm}{Energy dependent flux in both cells of the reactor, ' ...
    'generated by VBUDSII run a, Serpent, and MCNPX.}\n']);

fprintf(fid,['\\fitzefigtwo{figs/' reportname 'flux' num2str(p.resolveXS) ...
    'vbsm}{Energy dependent flux in both cells of the reactor, ' ...
    'generated by VBUDSII run b, Serpent, and MCNPX.}\n']);

fprintf(fid,['\\fitzefigtwo{figs/' reportname 'flux' num2str(p.resolveXS) ...
    'vam}{Energy dependent flux in both cells of the reactor, ' ...
    'generated by VBUDSII run a and MCNPX.}\n']);

fprintf(fid,['\\fitzefigtwo{figs/' reportname 'flux' num2str(p.resolveXS) ...
    'vas}{Energy dependent flux in both cells of the reactor, ' ...
    'generated by VBUDSII run a and Serpent.}\n']);
...
fprintf(fid,['\\fitzefigtwo{figs/' reportname 'flux' num2str(p.resolveXS) ...
    'sm}{Energy dependent flux in both cells of the reactor, ' ...
    'generated by Serpent and MCNPX.}\n']);

fprintf(fid,['\\fitzefigtwo{figs/' reportname 'flux' num2str(p.resolveXS) ...
    'vavbs}{Energy dependent flux in both cells of the reactor, ' ...
    'generated by VBUDSII run a, VBUDSII run b, and Serpent.}\n']);
    ...
    for cellidx = 1:g.regionDef(1).nCells
        ...
        for zidx = 1:length(g.regionDef(1).cellDef(cellidx).initZAIDs)
            ...
            if Z ~= 222
                ...
                SXS = cell(1, 3 + ...
                    g.regionDef(1).cellDef(cellidx).isFissionable);
                for iMT = 1:3 + 2*L.z(L.ZAID(Z)).isFissionable
                    ...
                    if iMT <= 4
                        SXS{iMT} = eval(['DET' ...
                            'c' g.regionDef(1).cellDef(cellidx).name ...
                            'z' num2str(Z) ...
                            'm' mtsz{iMT,2} ...
                            '(:,11)']);
                        if mtsz{iMT,1} == 2
                    ...
                    if iMT <= 4
                        printxsn(figdir, [reportname 'xscell' num2str(cellidx) ...
                            ...
                            0,0,0,[],'', {...
                            lgdzM{iMT}, lgdzS{iMT}, lgdzV{iMT}, lgdzV2{iMT}...
                            }, ...
                            '', ...
                            L.groupDef, {MXS{iMT}, SXS{iMT}, VXS{iMT}, V2XS{iMT}});
                            %0,0,0,[1e-8 1e4],'', {...
                    else
                        printxsn(figdir, [reportname 'xscell' num2str(cellidx) ...
                            'z' num2str(Z) 'm' num2str(mtsz{iMT,1})],...
...
fclose(fid);
system(sprintf('rubber --into=%s --pdf %s.tex',dir4report, ...
    [dir4report reportname]));
