function [pL, p, g, vbudsiflux] = mcnpxsimplantthermalbound(vbudsiiDir)

pL = struct('metamat','FarmXSMetaBound',...
                'address','/home/fitze/Dropbox/UTA/r/code/vbudsii/data/XSFarmBound',...
               'verbose',1,...
               'explore',0,...
                  'mine',0,...
                 'plant',0,...
             'fertilize',0,...
               'harvest',1,...
                     ...
                     'h',struct('makeLibrary',1,...
                                 'makeArrays',0),...
                 'ZAIDs',[8016 92235 92238]);
%                     'farmInelastic',1,...
                                         %6 2;
%                                         3 4;
%                'address','/home/fitze/LANL/XSFarmMCNPXSImplant',...
...
p = struct('nFineGroups',length(fineGroupDef)-1,... % leave blank.
           ...
           'XSLibraryMAT',fullfile('XSLibrarySandbox.mat'),...
...
g.regionDef(1).cellDef(1).initTemp = 600; %300 + 273;
% UO2 cell
...
g.regionDef(1).cellDef(2).initTemp = 900; %900 + 273;

load('../benchmarkvbuds3.mat');
